...
#include "service_interfaces/srv/detail/patrol__rosidl_typesupport_fastrtps_c.h"
...
using _Patrol_Request__ros_msg_type = service_interfaces__srv__Patrol_Request;
...
size_t get_serialized_size_service_interfaces__srv__Patrol_Request(
  const void * untyped_ros_message,
...
static uint32_t _Patrol_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_service_interfaces__srv__Patrol_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_service_interfaces
size_t max_serialized_size_service_interfaces__srv__Patrol_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = service_interfaces__srv__Patrol_Request;
    is_plain =
      (
...
static size_t _Patrol_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_service_interfaces__srv__Patrol_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, service_interfaces, srv, Patrol_Request)() {
...
using _Patrol_Response__ros_msg_type = service_interfaces__srv__Patrol_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_service_interfaces
size_t get_serialized_size_service_interfaces__srv__Patrol_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Patrol_Response__ros_msg_type * ros_message = static_cast<const _Patrol_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_service_interfaces__srv__Patrol_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_service_interfaces
size_t max_serialized_size_service_interfaces__srv__Patrol_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = service_interfaces__srv__Patrol_Response;
    is_plain =
      (
...
static size_t _Patrol_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_service_interfaces__srv__Patrol_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, service_interfaces, srv, Patrol_Response)() {
...
// already included above
// #include "service_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "service_interfaces/srv/patrol.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, service_interfaces, srv, Patrol)() {
