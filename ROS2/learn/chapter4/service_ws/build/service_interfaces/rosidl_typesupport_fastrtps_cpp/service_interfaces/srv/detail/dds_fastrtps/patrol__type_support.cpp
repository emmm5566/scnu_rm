...
#include "service_interfaces/srv/detail/patrol__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = service_interfaces::srv::Patrol_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const service_interfaces::srv::Patrol_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<service_interfaces::srv::Patrol_Request *>(
    untyped_ros_message);
...
{
  return &service_interfaces::srv::typesupport_fastrtps_cpp::_Patrol_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = service_interfaces::srv::Patrol_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const service_interfaces::srv::Patrol_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<service_interfaces::srv::Patrol_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &service_interfaces::srv::typesupport_fastrtps_cpp::_Patrol_Response__handle;
}
...
{
  return &service_interfaces::srv::typesupport_fastrtps_cpp::_Patrol__handle;
}
