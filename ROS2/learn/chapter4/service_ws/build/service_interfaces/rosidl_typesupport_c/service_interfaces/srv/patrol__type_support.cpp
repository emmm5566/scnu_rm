...
static const _Patrol_Request_type_support_symbol_names_t _Patrol_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, service_interfaces, srv, Patrol_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_interfaces, srv, Patrol_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, service_interfaces, srv, Patrol_Request)() {
  return &::service_interfaces::srv::rosidl_typesupport_c::Patrol_Request_message_type_support_handle;
}
...
static const _Patrol_Response_type_support_symbol_names_t _Patrol_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, service_interfaces, srv, Patrol_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_interfaces, srv, Patrol_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, service_interfaces, srv, Patrol_Response)() {
  return &::service_interfaces::srv::rosidl_typesupport_c::Patrol_Response_message_type_support_handle;
}
...
static const _Patrol_type_support_symbol_names_t _Patrol_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, service_interfaces, srv, Patrol)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_interfaces, srv, Patrol)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, service_interfaces, srv, Patrol)() {
  return &::service_interfaces::srv::rosidl_typesupport_c::Patrol_service_type_support_handle;
}
