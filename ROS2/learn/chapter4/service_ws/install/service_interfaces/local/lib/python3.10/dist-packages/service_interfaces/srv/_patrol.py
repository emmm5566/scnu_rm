...
class Metaclass_Patrol(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from service_interfaces.srv import _patrol
...
class Patrol(metaclass=Metaclass_Patrol):
    from service_interfaces.srv._patrol import Patrol_Request as Request
    from service_interfaces.srv._patrol import Patrol_Response as Response
