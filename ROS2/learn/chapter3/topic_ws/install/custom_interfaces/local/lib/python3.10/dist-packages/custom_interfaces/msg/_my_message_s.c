...
bool custom_interfaces__msg__my_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces.msg._my_message.MyMessage", full_classname_dest, 43) == 0);
  }
  custom_interfaces__msg__MyMessage * ros_message = _ros_message;
  {  // content
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * custom_interfaces__msg__my_message__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of MyMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._my_message");
  ...
  custom_interfaces__msg__MyMessage * ros_message = (custom_interfaces__msg__MyMessage *)raw_ros_message;
  {  // content
    PyObject * field = NULL;
